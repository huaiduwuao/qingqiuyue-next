...
export const bodyPlayAction: ToolDefinition<{
  ...
  parameters: {
    ...
    properties: {
      ...
      speed: { type: 'number', minimum: 0.3, maximum: 2, default: 1 },
...
export const bodyMove: ToolDefinition<{
  ...
  parameters: {
    ...
    properties: {
      ...
      durationMs: { type: 'integer', minimum: 200, maximum: 6000, default: 1500 },
      style: { type: 'string', enum: ['walk', 'run', 'teleport'], default: 'walk' },
    },
    required: ['target'],
  },
