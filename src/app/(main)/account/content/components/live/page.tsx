...
import { page, process, remove, save, update } from '@/apis/content-live';
...
export default function LiveContentPage() {
  ...
  return (
    <Box sx={{ p: 2 }}>
      <Typography variant="h5" sx={{ mb: 2 }}>直播管理</Typography>
