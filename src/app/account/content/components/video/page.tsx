...
export default function VideoContentPage() {
  ...
  return (
    <Box sx={{ height: "100%", overflow: "hidden" }}>
      ...
      <DataGridTable columns={columns} fetchData={async (params) => { const res: any = await page('video', { ...params }); return { data: { records: res.data?.list || [], totalRow: res.data?.total || 0 }, success: res.code === 0 }; }} onEdit={handleEdit} onDelete={handleDelete} toolBarRender={() => <Button variant="contained" startIcon={<AddIcon />} onClick={() => handleEdit({})}>新建</Button>} />
