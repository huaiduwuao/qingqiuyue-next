...
import { page, remove, save, update } from '@/apis/content-vshow-item';
...
const LIST_KEY = ['content', 'vshow-item'];

export default function VshowItemContentPage({ detail, handleClose }: Props) {
  ...
  return (
    <Box sx={{ height: "100%", overflow: "hidden" }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
        <Typography variant="h5">{detail?.title || '综艺'} - 剧集管理</Typography>
