...
import { page, remove, save, update } from '@/apis/content-spider-queue';
import AddIcon from '@mui/icons-material/Add';
import DeleteIcon from '@mui/icons-material/Delete';
import EditIcon from '@mui/icons-material/Edit';
import type { GridColDef } from '@mui/x-data-grid';

const LIST_KEY = ['content', 'spider-queue'];

export default function SpiderQueueContentPage() {
  ...
  return (
    <Box sx={{ height: "100%", overflow: "hidden" }}>
      <Typography variant="h5" sx={{ mb: 2 }}>爬虫队列</Typography>
      <DataGridTable
        columns={columns}
