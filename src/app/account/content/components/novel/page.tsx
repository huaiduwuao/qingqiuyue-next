...
import { page, process, remove, save, update } from '@/apis/content-novel';
...
const LIST_KEY = ['content', 'novel'];

export default function NovelContentPage() {
  ...
  const handleEdit = (record: any) => {
    ...
    setFormValues({ title: record?.title || '', author: record?.author || '', info: record?.info || '' });
