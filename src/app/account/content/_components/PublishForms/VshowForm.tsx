...
export default function VshowForm({ onSuccess }: PublishFormProps) {
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Box>
            ...
            {cover ? (
              ...
              >
                ...
                <Typography sx={{ fontSize: 10, color: 'text.secondary' }}>9:16 封面</Typography>
              </Box>
            )}
            <input
              ref={coverInputRef}
          ...
          >
            ...
            <Typography sx={{ fontSize: 11, lineHeight: 1.7, opacity: 0.85 }}>
              短剧强制竖屏 9:16。每集独立上传视频,单集建议 1-3 分钟。
              后续要加:分集解锁 / 投币 / 关联小程序端付费。
            </Typography>
          </Box>
