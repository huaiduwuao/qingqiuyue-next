...
//
// LRC 格式:[00:00.00]歌词 — 第一版只做 textarea 编辑,不解析时间轴
// 做 karaoke 预览(那需要音频播放器联动,工作量翻倍)。后续要加:
//   - 歌词逐行时间轴编辑器(每行有 [+00:00.50] [-00:00.50] 微调按钮)
//   - 音频波形预览 + 歌词高亮滚动
//   - 和声/分轨上传(多音频 + 各自时间轴)
const MAX_TITLE = 40;
const MAX_ARTIST = 40;
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography sx={{ fontSize: 12, color: 'text.secondary', mt: 0.25 }}>
            支持 mp3 / flac / wav / m4a · 1:1 封面(300×300 推荐) · LRC 歌词(选填)
          </Typography>
        </Box>
      </Box>
