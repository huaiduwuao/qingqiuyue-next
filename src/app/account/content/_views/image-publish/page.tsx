...
//
// 重构后:title/desc/tags/snack/submit 走 useContentForm hook,本 view
// 只管 images[] 自己的状态机(每张图独立 idle/uploading/uploaded/failed)。
// 这样后面 novel/music/comics 等 view 都能复用 hook,只写各自特殊字段。
const MAX_IMAGES = 9;
