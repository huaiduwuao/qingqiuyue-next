                  ...
                  <Box key={c.id} sx={{ p: 2, borderRadius: 2, bgcolor: 'background.paper', border: '1px solid', borderColor: 'divider' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5 }}>
                      ...
                      <Box sx={{ flex: 1, minWidth: 0 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75, mb: 0.25 }}>
                          ...
                          <Box sx={{ px: 0.5, py: 0.125, borderRadius: 0.5, bgcolor: sm.bg, color: sm.color, fontSize: 10, fontWeight: 700 }}>{sm.label}</Box>
                        </Box>
                    ...
                    <Box sx={{ mb: 1.5 }}>
                      ...
                      <LinearProgress
                        variant="determinate"
                        value={c.progress}
                        sx={{ height: 4, borderRadius: 1, bgcolor: 'rgba(255,255,255,0.06)', '& .MuiLinearProgress-bar': { background: 'linear-gradient(90deg, #FE2C55 0%, #FFB400 100%)' } }}
                      />
                    </Box>
        ...
        <Stack spacing={2.5}>
          ...
          <Box>
            ...
            <LinearProgress
              ...
              sx={{ height: 6, borderRadius: 1, bgcolor: 'rgba(255,255,255,0.06)', '& .MuiLinearProgress-bar': { background: 'linear-gradient(90deg, #FE2C55 0%, #FFB400 100%)' } }}
            />
          </Box>
