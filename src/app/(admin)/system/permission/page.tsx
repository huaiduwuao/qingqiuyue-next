...
import { page, remove, save, update } from '@/apis/system-permission';
...
const LIST_KEY = ['system', 'permission'];
...
export default function SystemPermissionPage() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      <DataGridTable
        columns={columns}
        actionPermissions={{ edit: PERMISSIONS.SYSTEM_PERMISSION.UPDATE, delete: PERMISSIONS.SYSTEM_PERMISSION.DELETE }}
        hasPermission={can}
        ...
        toolBarRender={() => (
          <PermissionGuard need={PERMISSIONS.SYSTEM_PERMISSION.CREATE}>
            <Button
              variant="contained"
              startIcon={<AddIcon />}
              onClick={() => handleEdit({})}
