...
parsers = [
    {
        ...
        'params_template': {"playType": "1", "auth_mode": "1", "definitionType": "2", "video_id": "$3", "did": "$random32", "suuid": "$random36", "vf": "av01,h265,h264", "type": "pch5", "_support": "10000000", "src": "mgtv", "abroad": "0", "appVersion": "9.0.4"},
        'response_parse_script': {"streamsExpr": "data.stream.concat(data.stream_h265)", "urlPath": "item.url", "qualityPath": "item.standardName", "resPath": "item.videoWidth + 'x' + item.videoHeight", "needpayPath": "item.needPay", "domainPath": "data.stream_domain[0]", "playableMatch": [".m3u8", "m3u8?", "/atcl?", "pm2="], "resolve": {"match": ["/atcl?", "pm2="], "headers": {"Referer": "https://www.mgtv.com/"}, "urlField": "info", "finalExt": ".m3u8"}},
    ...
    },
    {
        ...
        'response_parse_script': {"streamsExpr": "data.dash.video", "urlPath": "item.baseUrl", "qualityPath": "item.new_description", "resPath": "item.width + 'x' + item.height"},
    ...
    },
    {
        ...
        'response_parse_script': {"streamsExpr": "data.vinfo.adlist[0].transcode", "urlPath": "item.cdns[0].url", "qualityPath": "item.qualitylabel"},
        'quality_field': 'quality',
        'quality_sort_key': 'quality',
        'priority': 30,
        'remark': '腾讯视频流解析'
    },
    {
        ...
        'response_parse_script': {"streamsExpr": "data", "urlPath": "item.url", "qualityPath": "item.br"},
        'quality_field': 'quality',
        'quality_sort_key': 'quality',
        'priority': 40,
        'remark': '网易云音乐音频解析'
    },
    {
        ...
        'response_parse_script': {"streamsExpr": "data.stream", "urlPath": "item.url", "qualityPath": "item.name"},
        'quality_field': 'quality',
        'quality_sort_key': 'quality',
        'priority': 50,
        'remark': '虎牙直播流解析'
